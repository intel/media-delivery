...
ifelse(OS_NAME:OS_VERSION,ubuntu:20.04,`DECLARE(`PMT_BACKPORTS_VER',22WW40_449.2_UBUNTU514)')
ifelse(OS_NAME:OS_VERSION,ubuntu:22.04,`DECLARE(`PMT_BACKPORTS_VER',22WW40_449.2_UBUNTU517)')
