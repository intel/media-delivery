...
ifelse(OS_NAME:OS_VERSION,ubuntu:20.04,`DECLARE(`PMT_BACKPORTS_VER',22WW32_392_UBUNTU514)')
ifelse(OS_NAME:OS_VERSION,ubuntu:22.04,`DECLARE(`PMT_BACKPORTS_VER',22WW32_392_UBUNTU517)')
